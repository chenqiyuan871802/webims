...
<head>
    ...
    <link rel="stylesheet" href="${ctx}/static/weblib/bootstrap/css/bootstrap.min.css">
    <link rel="stylesheet" href="${ctx}/static/webframe/css/font-awesome.min.css">
    <link rel="stylesheet" href="${ctx}/static/webframe/css/index.css">
    <script src="${ctx}/static/weblib/jquery/jQuery-2.2.0.min.js"></script>
    <script src="${ctx}/static/weblib/charts/Chart.js"></script>
    <script>
        $(function () {
            Canvas1();
            Canvas2();
