...
if(opts.pagination){
	//修改提交参数：page->pageNum;rows->pageSize
$.extend(_7c4,{pageNum:opts.pageNumber||1,pageSize:opts.pageSize});
}
if(opts.sortName){
...
$.fn.combo.defaults=$.extend({},$.fn.textbox.defaults,{inputEvents:{click:_a1a,
	keyup//keydown改为keyup中文搜索不行所以修改2016.4.29 郝明才
	:_a1e,paste:_a1e,drop:_a1e},panelWidth:null,panelHeight:200,panelMinWidth:null,panelMaxWidth:null,panelMinHeight:null,panelMaxHeight:null,panelAlign:"left",reversed:false,multiple:false,multivalue:true,selectOnNavigation:true,separator:",",hasDownArrow:true,delay:200,keyHandler:{up:function(e){
},down:function(e){
},left:function(e){
},right:function(e){
},enter:function(e){
