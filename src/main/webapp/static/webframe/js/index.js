    ...
    $.learuntab = {
        ...
        addTab: function () {
            ...
            if (flag) {
                ...
                var str1 = '<iframe class="LRADMS_iframe" id="iframe' + dataId + '" name="iframe' + dataId + '"  width="100%" height="100%" scrolling="auto" frameborder="0"  src="' + dataUrl + '"  data-id="' + dataUrl + '" seamless></iframe>';
