...
public class WebplusQrcode {
	 ...
	 * @throws Exception
	 */
	public static String encodeBase64(String content, String logoPath, boolean needCompress) {
		...
		try {
	        ...
	        String baes64Png=   Base64.encodeBase64String(bytes).trim();//转换成base64串
	        baes64Png = baes64Png.replaceAll("\n", "").replaceAll("\r", "");//删除 \r\n
	        return baes64Png;
