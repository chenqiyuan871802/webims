...
import com.toonan.system.mapper.DictIndexMapper;
...
public class DictIndexService extends ServiceImpl<DictIndexMapper, DictIndex> {
	...
	public DictIndex getByDictKey(String key){
		DictIndex index = new DictIndex();
		index.setDictKey(key);
	    return baseMapper.selectOne(index);
	};
